...
//use as
/* new dbwriteasynctask(AppDatabase.getInstance(getApplicationContext()), new dbwriteasynctask.AsyncListener() {
@Override
public void onPostExecute() {
        }
}).execute(s);
